...
def after_install():
    """Create default settings after app installation"""
    create_default_whatsapp_account()
    create_default_mediasoup_settings()


def create_default_whatsapp_account():
...
def create_default_mediasoup_settings():
